...
export async function setVSCode() {
  try {
    await createFileFromWebTemplate('https://raw.githubusercontent.com/AloisSeckar/nuxt-ignis/refs/tags/v0.6.0/core/bin/templates/vscode-settings.json.template', '.vscode/settings.json')
  } catch (error) {
