...
export async function setNetlify() {
  try {
    await createFileFromWebTemplate('https://raw.githubusercontent.com/AloisSeckar/nuxt-ignis/refs/tags/v0.6.1/core/bin/templates/netlify.toml.template', 'netlify.toml')
  } catch (error) {
