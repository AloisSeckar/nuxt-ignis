...
export async function setCSS() {
  try {
    await createFileFromWebTemplate('https://raw.githubusercontent.com/AloisSeckar/nuxt-ignis/refs/tags/v0.5.3/modules/02-ui/src/runtime/css/ignis.css', 'app/assets/css/ignis.css')
  } catch (error) {
