...
export async function setCSS() {
  try {
    await createFileFromWebTemplate('https://raw.githubusercontent.com/AloisSeckar/nuxt-ignis/refs/tags/v0.6.1/modules/01-default/src/runtime/css/ignis.css', 'app/assets/css/ignis.css')
  } catch (error) {
