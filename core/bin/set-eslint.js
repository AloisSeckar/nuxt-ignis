...
export async function setESLint() {
  try {
    await createFileFromWebTemplate('https://raw.githubusercontent.com/AloisSeckar/nuxt-ignis/refs/tags/v0.6.0-rc.1/core/bin/templates/eslint.config.mjs.template', 'eslint.config.mjs')
  } catch (error) {
