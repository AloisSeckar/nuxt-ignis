...
- use `NUXT_PUBLIC_IGNIS_DEFAULT_ESLINT=false` to disable [`@nuxt/eslint`](/3-9-features-devex.html#eslint)
- use `NUXT_PUBLIC_IGNIS_DEFAULT_FONTS=false` to disable [`@nuxt/fonts`](/3-8-features-performance.html#nuxt-fonts)
- use `NUXT_PUBLIC_IGNIS_DEFAULT_IMAGE=false` to disable [`@nuxt/image`](/3-8-features-performance.html#nuxt-image)
- use `NUXT_PUBLIC_IGNIS_DEFAULT_SCRIPTS=false` to disable [`@nuxt/scripts`](/3-8-features-performance.html#nuxt-scripts)
- use `NUXT_PUBLIC_IGNIS_DEFAULT_SECURITY=false` to disable [`nuxt-security`](/3-9-features-devex.html#nuxt-security)
- use `NUXT_PUBLIC_IGNIS_DEFAULT_AUTH=false` to disable [`nuxt-auth-utils`](/3-7-features-utils.html#nuxt-auth-utils)
