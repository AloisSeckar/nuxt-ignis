...
<PackagesReference :packages="[{ name: 'nuxt-spec', version: 'v0.2.2' }]" />
...
Read more in the project [README](https://github.com/AloisSeckar/nuxt-spec/blob/v0.2.2/README.md).
