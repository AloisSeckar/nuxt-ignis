...
## Default CSS file
There is a default CSS file [`ignis.css`](https://github.com/AloisSeckar/nuxt-ignis/blob/v0.6.1/modules/01-default/src/runtime/css/ignis.css) that is included in the project by default. It contains basic styling for the HTML apps based on good practices and recommendations.
...
<PackagesReference :packages="[{ name: '@nuxt/ui', version: '4.10.0' }]" />
...
Your custom CSS files may be added via [dedicated option](/3-10-features-nuxt.html#css).

## Tailwind CSS

<PackagesReference :packages="[{ name: 'tailwindcss', version: '4.3.3' }, { name: '@tailwindcss/vite', version: '4.3.3' }]" />
...
<PackagesReference :packages="[{ name: 'nuxt-charts', version: '2.2.0' }]" />
...
Refer to [this page](/3-10-features-nuxt.html#css) for more details.
