...
| --- | :---: | :---: | :-- |
| `nuxt` | `4.4.7` | [👁️‍🗨️](/3-10-features-nuxt.html) | Underlying Nuxt application itself |
| `vue` | `3.5.35` | [👁️‍🗨️](/3-10-features-nuxt.html)  | Explicit devDependency to align with Nuxt defaults and also due to [Netlify behavior](https://github.com/nuxt/nuxt/discussions/30187) |
| `vue-router` | `5.1.0` | [👁️‍🗨️](/3-10-features-nuxt.html)  | Explicit devDependency to align with Nuxt defaults and also due to [Netlify behavior](https://github.com/nuxt/nuxt/discussions/30187) |
...
| `nuxt-spec` | `v0.2.3` | [👁️‍🗨️](/5-1-contributing.html#testing) | Experimental aggregated testing solution (`vitest` && `playwright` && Nuxt/Vue test utils) |
...
| Package | Version | Detail | Description |
| --- | :---: | :---: | :-- |
| `@nuxt/eslint` | `1.16.0` | [👁️‍🗨️](/3-9-features-devex.html#eslint) | Official module for code linting via `eslint` |
...
| `@nuxt/scripts` | `1.1.0` | [👁️‍🗨️](/3-8-features-performance.html#nuxt-scripts) | Official module for integrating 3rd party scripts |
...
| `@vueuse/core` | `14.3.0` | [👁️‍🗨️](/3-7-features-utils.html#vueuse) | Collection of handy Vue utility functions |
| `@vueuse/nuxt` | `14.3.0` | [👁️‍🗨️](/3-7-features-utils.html#vueuse) | Nuxt connector for `VueUse` |
...
| Package | Version | Detail | Description |
| --- | :---: | :---: | :-- |
| `@nuxt/ui` | `4.8.2` | [👁️‍🗨️](/3-2-features-ui.html#nuxt-ui) | Official open-source UI library for Nuxt |
| `@nuxtjs/tailwindcss` | `6.14.0` | [👁️‍🗨️](/3-2-features-ui.html#tailwind-css) | Connector module for `Tailwind CSS` (**TEMP DISABLED**) |
| `@tailwindcss` | `4.3.0` | [👁️‍🗨️](/3-2-features-ui.html#tailwind-css) | Base module for `Tailwind CSS` (**TEMP WORKAROUND**) |
| `@tailwindcss/vite` | `4.3.0` | [👁️‍🗨️](/3-2-features-ui.html#tailwind-css) | Vite connector for `Tailwind CSS` (**TEMP WORKAROUND**) |
| `nuxt-neon` | `0.8.3` | [👁️‍🗨️](/3-3-features-db.html#neon) | Connector module for `Neon` database |
| `@nuxtjs/supabase` | `2.0.8` | [👁️‍🗨️](/3-3-features-db.html#supabase) | Connector module for `Supabase` database |
...
| `@nuxt/content` | `3.14.0` | [👁️‍🗨️](/3-6-features-content.html#nuxt-content) | Official module for displaying `.md` content |
| `@nuxtjs/i18n` | `10.3.0` | [👁️‍🗨️](/3-6-features-content.html#i18n) | Module for adding `i18n` internationalization into apps |
...
| `valibot` | `1.4.0` | [👁️‍🗨️](/3-5-features-validation.html#valibot) | Schema validation solution |
