...
The file will be created as `app/app.vue` and will be equal to the [Nuxt Ignis default](https://github.com/AloisSeckar/nuxt-ignis/blob/v0.6.0-rc.3/core/app/app.vue).
...
The file will be created as `app/assets/css/ignis.css` and will be equal to the [Nuxt Ignis default](https://github.com/AloisSeckar/nuxt-ignis/blob/v0.6.0-rc.3/modules/01-default/src/runtime/css/ignis.css).
...
The file will be created as `eslint.config.mjs` and will be equal to the [Nuxt Ignis default](https://github.com/AloisSeckar/nuxt-ignis/blob/v0.6.0-rc.3/core/eslint.config.mjs).
...
The file will be created as `netlify.toml` in project root with [default contents](https://github.com/AloisSeckar/nuxt-ignis/blob/v0.6.0-rc.3/core/bin/templates/netlify.toml.template).
...
The file will be created as `.vscode/settings.json` with [default contents](https://github.com/AloisSeckar/nuxt-ignis/blob/v0.6.0-rc.3/core/bin/templates/vscode-settings.json.template).
