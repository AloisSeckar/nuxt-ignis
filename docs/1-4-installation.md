...
7) Optionally replace default `app/app.vue` in fresh project (the file contains `<NuxtWelcome />` component) with the [Nuxt Ignis default](https://github.com/AloisSeckar/nuxt-ignis/blob/v0.6.0-rc.3/core/app/app.vue).
